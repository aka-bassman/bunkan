import type { Dayjs, Any, PromiseOrObject, UnCls } from "@akanjs/base";
import type {
...
import { type ArgType, type SignalOption } from "./signalDecorators";
...
> {
  ...
  >(name: ArgName, argRef: Arg, option?: ApiArgProps<Optional>) {
    ...
    return this as unknown as ApiInfo<
      ...
      [
        ...ServerArgs,
        arg: _ServerArg | (Optional extends true ? undefined : never),
      ],
      Returns,
      ServerReturns,
      Nullable
  ...
  exec<
    ExecFn extends (
      ...
      : PromiseOrObject<
          ...
          | (Nullable extends true ? null | undefined : never)
        >,
  >(
    execFn: ExecFn,
  ): ApiInfo<
  ...
  //   if (!execFn) throw new Error(`Exec function is not set for ${key}`);
  //   signalInfo.setHandlerKey(execFn, key);
  //   const [singleReturnRef, returnArrDepth] = getNonArrayModel(
  //     this.returnRef as Cls,
  //   );
  //   const apiMeta: GqlMeta = {
  //     returns: () =>
  //       arraiedModel(
  //         isEnum(singleReturnRef)
  //           ? ((singleReturnRef as EnumInstance).type as Cls)
  //           : singleReturnRef,
  //         returnArrDepth,
  //       ) as Cls,
  ...
  //   };
  //   (sigRef.prototype as { [key: string]: any })[key] = this.execFn;
...
export type BuildApiSignal<ApiInfoMap> = {
  ...
  >
    ? (
        ...args: Args
      ) => ApiInfoReturn<ReqType, Returns, ServerReturns, Nullable>
    : never;
};
...
export const makeApiBuilder = <Srvs extends { [key: string]: any }>() => ({
  ...
  >(
    ...
    new ApiInfo<"query", Srvs, [], [], [], [], Returns, never, Nullable>(
      "query",
      returnRef,
      signalOption,
    ),
  ...
  >(
    ...
    new ApiInfo<"mutation", Srvs, [], [], [], [], Returns, never, Nullable>(
      "mutation",
      returnRef,
      signalOption,
    ),
  ...
  >(
    ...
    new ApiInfo<"pubsub", Srvs, [], [], [], [], Returns, never, Nullable>(
      "pubsub",
      returnRef,
      signalOption,
    ),
  ...
  >(
    ...
    new ApiInfo<"message", Srvs, [], [], [], [], Returns, never, Nullable>(
      "message",
      returnRef,
      signalOption,
    ),
