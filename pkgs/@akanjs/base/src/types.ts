...
export type Cls<T = any, Statics = unknown> = (new (...args: any[]) => T) & Statics;
...
export type MergeAllActionTypes<T extends Cls[], OmitKey extends string = never> = T extends [
...
export type MergeAllTypes<T extends Cls[], OmitKey extends string = never> = T extends [
  infer First extends Cls,
  ...infer Rest extends Cls[],
]
  ? Rest extends []
...
export type MergeAllKeyOfTypes<T extends Cls<{ [key: string]: any }>[], Key extends string> = T extends [
  infer First extends Cls,
  ...infer Rest extends Cls[],
]
  ? Rest extends []
...
export type MergeAllKeyOfObjects<T extends { [key: string]: any }[], Key extends string | symbol> = T extends [
